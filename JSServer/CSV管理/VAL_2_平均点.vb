Public Class VAL_2_平均点
    ...
    Public Sub CreateCSV(採点結果 As 採点結果_V2)
        ...
        If 採点結果.ラウンド番号 = "200" Then
            ...
            filename = "VAL2_AVERAGE_SF.csv"

        ElseIf 採点結果.ラウンド番号 = "400" Then

            filename = "VAL2_AVERAGE_FF.csv"

        Else

            filename = "VAL2_AVERAGE_" & 採点結果.ラウンド番号 & ".csv"
        ...
        For s = 1 To 採点結果.出場選手数
            ...
            For p = 1 To PCS数
                ...
                データ(行数) = データ(行数) & "," & 採点結果.種目(1).選手結果(s).PCS得点(p).PCS得点.ToString("0.000")
