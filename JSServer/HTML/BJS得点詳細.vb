Public Class BJS得点詳細
    ...
    Private Sub 総合結果表作成(言語 As String, 採点結果 As 採点結果_C)
        ...
        Dim 競技種別 As String
        If 採点結果.マスタデータ.D_種目マスタ.Get_SG種別表記名(採点結果.区分番号, 採点結果.ラウンド番号, 1) = "ソロ" Then
            競技種別 = "ソロ"
        ...
        For k = 1 To 対象区分数   '区分数分ループ
            ...
            If 区分 IsNot Nothing Then
                ...
                If 競技種別 <> "ソロ" Then
                    i = i + 1 : データ(i) = "         <td rowspan=""2"" class=""pcs"">" & 対象採点結果(k).区分番号 & "</td>"
                    i = i + 1 : データ(i) = "         <td rowspan=""2"" class=""pcs"">" & 区分.区分表記名 & "</td>"
                End If
                ...
                For s = 1 To 対象採点結果(k).出場選手数
                    ...
                    If 競技種別 <> "ソロ" Then
                        ...
                        If 対象採点結果(k).勝ちFLAG(s) = 1 Or (UP検索(対象採点結果(k).背番号(s), 採点結果) = "UP" And 次ラウンド無し = False) Then
                            ...
                            i = i + 1 : データ(i) = "         <td class=""data02B"">" & "WIN" & " </td>"  '結果
                        ...
                        Else
                            ...
                            i = i + 1 : データ(i) = "         <td class=""pcs"">" & "</td>"  '結果
                    ...
                    Else
                        ...
                        If UP検索(対象採点結果(k).背番号(s), 採点結果) = "UP" Then
                            i = i + 1 : データ(i) = "         <td class=""data02B"">" & 対象採点結果(k).背番号(s) & "</td>"
                            i = i + 1 : データ(i) = "         <td class=""data02B"">" & "UP" & " </td>"  '結果
                            i = i + 1 : データ(i) = "         <td class=""data02B"">" & 選手.リーダー表記名 & "</td>"
                            i = i + 1 : データ(i) = "         <td class=""data02B"">" & 選手.カップル所属名 & "</td>"
                        Else
                            i = i + 1 : データ(i) = "         <td class=""data01"">" & 対象採点結果(k).背番号(s) & "</td>"
                    ...
                    End If
                        ...
                        i = i + 1 : データ(i) = "         <td class=""TotalScore"">" & 対象採点結果(k).WIN数(s) & "</td>"  '勝った数
