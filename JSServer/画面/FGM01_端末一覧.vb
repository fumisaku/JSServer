Public Class FGM01_端末一覧
    ...
    Private Sub FGM01_端末一覧_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub 一覧更新(TCPClient() As TCPClient, GM_ As F_GM)
        ...
        Me.LB_端末数.Text = GM.TCPServer.AcceptedClients.Count & " 台接続中"
